 ...
 */
final class Version20200415114033 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TEMPORARY TABLE __temp__user AS SELECT id, username, password, name, email, roles, enabled, confirmation_token FROM user');
        ...
        , confirmation_token VARCHAR(40) DEFAULT NULL COLLATE BINARY, enabled BOOLEAN NOT NULL)');
        $this->addSql('INSERT INTO user (id, username, password, name, email, roles, enabled, confirmation_token) SELECT id, username, password, name, email, roles, enabled, confirmation_token FROM __temp__user');
